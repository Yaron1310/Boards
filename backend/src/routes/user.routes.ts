...
userRouter.get('/:userId', requireRole([UserRole.ORGANIZATION_ADMIN, UserRole.ORG_EDITOR, UserRole.WORKSPACE_ADMIN, UserRole.SYSTEM_ADMIN]), userController.getUserById);
