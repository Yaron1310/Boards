            ...
            <section id="terms" className="mb-12">
                ...
                <div className="prose prose-sm text-gray-600 space-y-4 max-w-none">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>"WorkHub"</strong>: Refers to the content creator, educator, or entity responsible for designing courses, configuring AI mentors, and managing educational material hosted on the Platform.</li>
                        <li><strong>"WorkHub"</strong>: Refers to the business customer or entity that subscribes to a Workhub's content to provide access to its members/employees.</li>
                    ...
                    <h3>7. WorkHub Content and Platform Neutrality</h3>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        <li><strong>Content Responsibility:</strong> All courses, materials, and specific AI behavior instructions are created and managed solely by the <strong>Workhub</strong>. The Workhub is solely responsible for the accuracy, legality, and safety of their content.</li>
                        <li><strong>No Liability:</strong> Logyx is not liable for any misinformation, harmful advice, or offensive material resulting from a Workhub's configuration of the AI or their course content. Any reliance on such content is at your own risk.</li>
                        <li><strong>Disputes & Reporting:</strong> Any disputes regarding course material, grading, or specific AI interactions should be directed to the administrator of your specific Workhub. However, if you believe any content hosted on our platform is harmful, illegal, or violates copyright laws, please send a detailed report to <a href="mailto:support@logyx.co.il" className="text-blue-600 hover:underline">support@logyx.co.il</a> so we may investigate in accordance with our policies.</li>
                    </ul>
