            ...
            <section id="terms" className="mb-12">
                ...
                <div className="prose prose-sm text-gray-600 space-y-4 max-w-none">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>"Academy"</strong>: Refers to the content creator, educator, or entity responsible for designing courses, configuring AI mentors, and managing educational material hosted on the Platform.</li>
                        <li><strong>"Organization"</strong>: Refers to the business customer or entity that subscribes to an Academy's content to provide access to its members/employees.</li>
                    ...
                    <h3>7. Academy Content and Platform Neutrality</h3>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        <li><strong>Content Responsibility:</strong> All courses, materials, and specific AI behavior instructions are created and managed solely by the <strong>Academy</strong>. The Academy is solely responsible for the accuracy, legality, and safety of their content.</li>
                        <li><strong>No Liability:</strong> Gymind is not liable for any misinformation, harmful advice, or offensive material resulting from an Academy's configuration of the AI or their course content. Any reliance on such content is at your own risk.</li>
                        <li><strong>Disputes & Reporting:</strong> Any disputes regarding course material, grading, or specific AI interactions should be directed to the administrator of your specific Academy or Organization. However, if you believe any content hosted on our platform is harmful, illegal, or violates copyright laws, please send a detailed report to <a href="mailto:support@gymind.app" className="text-blue-600 hover:underline">support@gymind.app</a> so we may investigate in accordance with our policies.</li>
                    </ul>
