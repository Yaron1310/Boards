            ...
            <section id="terms" className="mb-12">
                ...
                <div className="prose prose-sm text-gray-600 space-y-4 max-w-none">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>"WorkHub"</strong>: Refers to the business customer or entity that subscribes to an Workspace's content to provide access to its members/employees.</li>
